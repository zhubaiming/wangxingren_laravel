...
class OrderService
{
    ...
    public function create(array $collects, int $user_id, OrderStatusEnum $status = OrderStatusEnum::paying, ?string $type = null)
    {
        ...
        } elseif ($status === OrderStatusEnum::finishing) {
            /*
             * 消息推送
             * 1、推送后台
             * 2、推送企业微信机器人
